...
contract RenderSpecial2SelfTest {
    ...
    string private constant PART_6 = ';"/><path d="M94 211 L99 212 L100 217 L97 220 L101 222 L99 226 L96 226 L96 230 L94 230 L94 224 L87 227 L87 230 L89 232 L87 233 L83 229 L84 225 L86 222 L91 221 L88 220 L88 218 L91 218 L92 213 L95 215 L95 217 L98 217 L97 215 L94 213 Z" style="fill:';
    string private constant PART_7 = ';"/><path d="M55 35 L61 35 L62 39 L60 39 L61 41 L64 40 L64 38 L66 38 L65 43 L57 43 L56 47 L55 51 L57 52 L53 51 L53 49 L51 50 L51 54 L53 55 L50 55 L47 50 L50 45 L54 43 Z" style="fill:';
    string private constant PART_8 = ';"/><path d="M84 50 L87 51 L87 54 L93 50 L100 51 L98 59 L91 59 L90 56 L85 55 Z" style="fill:';
    string private constant PART_9 = ';"/><path d="M65 42 L70 43 L68 44 L69 51 L67 56 L64 56 L65 51 L63 47 L62 49 L60 49 L60 47 L58 47 L57 43 Z" style="fill:';
    ...
    string private constant PART_11 = ';"/><path d="M110 202 L113 203 L112 216 L107 217 L106 210 Z" style="fill:';
    string private constant PART_12 = ';"/><path d="M95 45 L98 45 L98 50 L100 49 L101 46 L104 46 L103 52 L102 54 L106 53 L106 55 L99 57 L99 52 L96 51 Z" style="fill:';
    string private constant PART_13 = ';"/><path d="M108 220 L115 220 L117 226 L114 231 L111 231 L111 229 L113 229 L112 224 L108 223 Z" style="fill:';
    string private constant PART_14 = ';"/><path d="M86 222 L93 222 L91 226 L87 227 L87 230 L89 232 L87 233 L83 229 L84 225 Z" style="fill:';
    string private constant PART_15 = ';"/><path d="M72 27 L75 28 L74 33 L71 41 L67 40 L67 36 L69 36 Z" style="fill:';
    string private constant PART_16 = ';"/><path d="M103 222 L108 224 L109 228 L106 234 L102 235 L102 233 L104 233 L104 227 Z" style="fill:';
    ...
    string private constant COLOR_1 = 'hsl(200, 4%, 15%)';
    ...
    string private constant COLOR_6 = 'hsl(25, 29%, 16%)';
    string private constant COLOR_7 = 'hsl(24, 7%, 14%)';
    string private constant COLOR_8 = 'hsl(24, 33%, 22%)';
    string private constant COLOR_9 = 'hsl(0, 0%, 10%)';
    string private constant COLOR_10 = 'hsl(25, 54%, 27%)';
    string private constant COLOR_11 = 'hsl(20, 5%, 11%)';
    string private constant COLOR_12 = 'hsl(26, 14%, 23%)';
    string private constant COLOR_13 = 'hsl(60, 1%, 20%)';
    string private constant COLOR_14 = 'hsl(20, 9%, 20%)';
    string private constant COLOR_15 = 'hsl(60, 1%, 18%)';
    string private constant COLOR_16 = 'hsl(26, 15%, 20%)';
