...
contract RenderAft0SelfTest {
    ...
    string private constant PART_10 = ';"/><path d="M197 129 L198 131 L207 132 L207 138 L195 138 L194 133 L193 140 L203 139 L208 140 L208 131 L209 131 L209 140 L212 140 L212 142 L189 143 L187 139 L183 136 L185 132 L185 136 L189 138 L192 140 L191 131 Z" style="fill:';
    string private constant PART_11 = ';"/><path d="M188 96 L193 97 L193 100 L196 100 L197 96 L204 97 L204 102 L193 103 L193 105 L203 105 L202 107 L192 108 L186 107 L185 109 L180 107 L180 114 L179 114 L179 106 L187 106 L187 104 L182 103 L184 102 L184 100 L188 100 Z" style="fill:';
    string private constant PART_12 = ';"/><path d="M223 129 L228 129 L228 142 L214 142 L214 133 L218 132 L222 131 Z" style="fill:';
    string private constant PART_13 = ';"/><path d="M214 114 L228 114 L228 125 L226 124 L219 125 L215 125 L214 125 Z" style="fill:';
    string private constant PART_14 = ';"/><path d="M223 149 L224 149 L225 156 L225 164 L231 162 L233 156 L234 156 L234 165 L224 168 L214 169 L214 153 L216 150 L216 164 L223 165 Z" style="fill:';
    string private constant PART_15 = ';"/><path d="M233 110 L242 110 L242 112 L247 113 L248 124 L249 128 L245 129 L243 123 L238 120 L235 119 L235 117 L237 117 L237 115 L243 116 L244 117 L245 115 L241 114 L234 112 L233 114 Z" style="fill:';
    ...
    string private constant PART_17 = ';"/><path d="M232 113 L234 114 L235 138 L237 139 L236 132 L238 132 L238 138 L242 138 L243 136 L246 136 L245 129 L247 129 L247 137 L245 137 L245 139 L242 139 L242 141 L234 142 L230 143 L232 142 Z" style="fill:';
    string private constant PART_18 = ';"/><path d="M226 122 L228 125 L228 129 L223 129 L221 133 L218 133 L216 134 L214 133 L214 125 L216 123 L219 124 L226 124 Z" style="fill:';
    string private constant PART_19 = ';"/><path d="M208 114 L212 114 L212 140 L209 140 L207 121 Z" style="fill:';
    string private constant PART_20 = ';"/><path d="M234 150 L235 150 L235 158 L233 157 L231 163 L225 164 L224 152 L227 151 L232 152 L232 155 L234 155 Z" style="fill:';
    string private constant PART_21 = ';"/><path d="M192 147 L208 147 L208 166 L206 167 L205 164 L205 150 L191 150 Z M204 165 L205 167 L197 167 L197 166 Z" style="fill:';
    string private constant PART_22 = ';"/><path d="M234 112 L240 112 L245 115 L244 118 L237 115 L237 117 L235 117 L235 119 L241 120 L244 123 L244 125 L238 126 L236 129 L234 129 Z" style="fill:';
    string private constant PART_23 = ';"/><path d="M224 102 L228 103 L230 106 L230 111 L217 111 L217 105 L223 105 Z" style="fill:';
    string private constant PART_24 = ';"/><path d="M189 102 L206 102 L205 105 L214 106 L213 111 L206 111 L206 107 L202 106 L193 105 L193 103 Z" style="fill:';
    string private constant PART_25 = ';"/><path d="M229 114 L232 114 L232 142 L229 141 Z" style="fill:';
    string private constant PART_26 = ';"/><path d="M193 151 L204 151 L205 152 L205 157 L194 157 L194 160 L192 160 L192 152 Z" style="fill:';
    string private constant PART_27 = ';"/><path d="M212 149 L214 149 L214 167 L210 167 L209 167 L209 150 Z" style="fill:';
    string private constant PART_28 = ';"/><path d="M173 155 L179 156 L180 163 L176 164 L178 165 L177 166 L180 167 L180 169 L172 168 L175 167 L175 165 L173 165 Z" style="fill:';
    string private constant PART_29 = ';"/><path d="M183 103 L187 104 L187 106 L179 106 L180 115 L178 115 L178 109 L167 109 L167 111 L175 111 L176 114 L174 114 L174 112 L166 112 L166 107 L178 107 L178 104 Z" style="fill:';
    string private constant PART_30 = ';"/>';
    string private constant COLOR_1 = 'hsl(220, 9%, 13%)';
    string private constant COLOR_2 = 'hsl(220, 10%, 12%)';
    string private constant COLOR_3 = 'hsl(225, 3%, 23%)';
    string private constant COLOR_4 = 'hsl(120, 1%, 37%)';
    string private constant COLOR_5 = 'hsl(180, 1%, 32%)';
    string private constant COLOR_6 = 'hsl(223, 10%, 14%)';
    string private constant COLOR_7 = 'hsl(270, 2%, 16%)';
    string private constant COLOR_8 = 'hsl(270, 4%, 22%)';
    string private constant COLOR_9 = 'hsl(20, 38%, 41%)';
    string private constant COLOR_10 = 'hsl(205, 11%, 22%)';
    string private constant COLOR_11 = 'hsl(260, 3%, 21%)';
    string private constant COLOR_12 = 'hsl(120, 1%, 34%)';
    string private constant COLOR_13 = 'hsl(60, 2%, 39%)';
    string private constant COLOR_14 = 'hsl(230, 10%, 11%)';
    string private constant COLOR_15 = 'hsl(223, 8%, 18%)';
    string private constant COLOR_16 = 'hsl(48, 4%, 47%)';
    string private constant COLOR_17 = 'hsl(228, 9%, 11%)';
    string private constant COLOR_18 = 'hsl(210, 5%, 25%)';
    string private constant COLOR_19 = 'hsl(120, 1%, 35%)';
    string private constant COLOR_20 = 'hsl(24, 36%, 42%)';
    string private constant COLOR_21 = 'hsl(210, 4%, 29%)';
    string private constant COLOR_22 = 'hsl(45, 2%, 37%)';
    string private constant COLOR_23 = 'hsl(210, 1%, 31%)';
    string private constant COLOR_24 = 'hsl(21, 16%, 38%)';
    string private constant COLOR_25 = 'hsl(90, 1%, 35%)';
    string private constant COLOR_26 = 'hsl(45, 4%, 44%)';
    string private constant COLOR_27 = 'hsl(180, 1%, 33%)';
    string private constant COLOR_28 = 'hsl(220, 8%, 21%)';
    string private constant COLOR_29 = 'hsl(228, 9%, 10%)';
